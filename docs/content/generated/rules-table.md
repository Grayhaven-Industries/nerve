...
| `HK-ELEC-018` | `canTerminationCountWrong` | A high-speed CAN bus needs exactly two ~120Ω terminations; declaring one or three is a defect, declaring none is only reported for information. |
