...
export const RULE_SUMMARIES: ReadonlyMap<string, string> = new Map(
  Object.entries({
    ...
    gaugeOutsideConnectorRange: "Wire gauge must sit inside the fitted terminal's wireGaugeRange, or the housing's when no terminal record exists.",
    insulationOutsideTerminalRange: "Wire insulation OD must sit inside the terminal's insulation-barrel range.",
    insulationOutsideSealRange: "Wire insulation OD must sit inside the cavity seal's diameter range.",
